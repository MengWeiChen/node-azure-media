...
(function () {
    ...
    this.encodeVideo = function (assetId, encoder, callback) {
        async.waterfall([
            function (cb) {
                this.api.rest.mediaprocessor.getCurrentByName('Media Encoder Standard', cb);
            }.bind(this),
    ...
    this.encodeVideo2 = function (assetId, encoder1, encoder2, callback) {
        async.waterfall([
            function (cb) {
                this.api.rest.mediaprocessor.getCurrentByName('Media Encoder Standard', cb);
            }.bind(this),
            ...
            function (processor, asset, cb) {
                this.api.rest.job.create({
                    ...
                    InputMediaAssets: [{'__metadata': {uri: asset.__metadata.uri}}],
                    Tasks: [{
                        Configuration: encoder1,
                        MediaProcessorId: processor.Id,
                        TaskBody: "<?xml version=\"1.0\" encoding=\"utf-8\"?><taskBody><inputAsset>JobInputAsset(0)</inputAsset><outputAsset>JobOutputAsset(0)</outputAsset></taskBody>"
                    },{
                        Configuration: encoder2,
                        MediaProcessorId: processor.Id,
